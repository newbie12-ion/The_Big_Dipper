      ...
      {exporterBatches.map((batch, index) => (
        <AppCard key={batch.id} className={index === 0 ? "border-emerald-300" : ""}>
          ...
          <div className="mt-5 flex items-center justify-between">
            ...
            {index === 0 ? (
              <PrimaryButton className="h-12 w-auto px-5" onClick={() => navigate("/exporter/verify")}>
...
export const ExporterVerifyScreen = () => {
  ...
  return (
    <div className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-emerald-100">
                {language === "vi" ? "Đang đọc mã QR" : "Reading QR certificate"}
              </p>
      ...
      <PrimaryButton onClick={() => navigate("/exporter/purchase")}>
...
export const ExporterPurchaseScreen = () => {
  ...
  return (
    <div className="space-y-4">
      <button
        onClick={() => navigate("/exporter/verify")}
        className="flex items-center gap-2 text-sm font-semibold text-brand-muted"
      >
        <ArrowLeft className="h-4 w-4" />
      ...
      <SecondaryButton className="w-full" onClick={() => navigate("/farmer/home")}>
