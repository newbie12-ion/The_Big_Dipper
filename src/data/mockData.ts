...
export const scanScenarios: ScanScenario[] = [
  ...
  {
    id: "coffee-healthy",
    imageUrl: "/demo/coffee-healthy.svg",
  ...
  {
    id: "unknown-plant",
    imageUrl: "/demo/unknown-plant.svg",
...
export const seededLedgerEvents: LedgerEvent[] = [
  ...
  },
  {
    id: "evt-13",
    type: "irrigation",
    title: { vi: "Kiểm tra đường ống tưới", en: "Irrigation line inspection" },
    detail: {
      vi: "Áp suất và van Khu 1 đã được kiểm tra trước chu kỳ chiều.",
      en: "Zone 1 pressure and valves checked before the afternoon cycle.",
    },
    timestamp: "17:52",
    hash: makeHash("b3e4f057d9a3c78120e4eb7f3c97d12a19af0c1dd4279e0e"),
    blockNumber: 48303,
  },
  {
    id: "evt-14",
    ...
    detail: {
      vi: "Độ ẩm xuống 41%, sắp tới ngưỡng cần tưới.",
      en: "Soil moisture fell to 41%, approaching irrigation threshold.",
    },
    timestamp: "17:58",
    hash: makeHash("481d69d4aa331f3be2c214dfcc076870f109c72dab285e36"),
    blockNumber: 48305,
  },
];
...
export const certificateRows = [
  {
    label: { vi: "Định vị GPS lô đất (EUDR)", en: "Plot geolocation (EUDR)" },
    status: "ready",
  },
  {
    label: { vi: "Nhật ký phun thuốc", en: "Spray diary" },
    status: "ready",
  },
  {
    label: { vi: "Nhật ký tưới tiêu", en: "Irrigation log" },
    status: "ready",
  },
  {
    label: { vi: "Phân tích đất định kỳ", en: "Semiannual soil lab panel" },
    status: "ready",
  },
  {
    label: { vi: "Hồ sơ thu hoạch", en: "Harvest record" },
    status: "pending",
  },
] as const;
...
export const device = {
  ...
  network: "LoRaWAN",
  battery: 87,
  zone: { vi: "Đại diện Khu 1 · 0,5 ha", en: "Representative of Zone 1 · 0.5 ha" },
};
...
export const satelliteInsights = {
  ...
  boundary: "42,215 98,91 254,53 391,105 434,252 341,342 145,330",
  ndviZones: [
    { cx: "38%", cy: "34%", color: "#22c55e", opacity: 0.48 },
    { cx: "64%", cy: "60%", color: "#eab308", opacity: 0.38 },
    { cx: "78%", cy: "30%", color: "#ef4444", opacity: 0.38 },
  ],
};
