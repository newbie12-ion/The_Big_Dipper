...
export const BottomNav = ({
  ...
  const navItems = [
    { label: "Home", icon: Home, to: "/farmer/home" },
    { label: "Farm", icon: Leaf, to: "/farmer/farm" },
    { label: scanLabel, icon: Camera, to: "/farmer/scan" },
    { label: "Market", icon: LineChart, to: "/farmer/market" },
    { label: "Profile", icon: UserRound, to: "/farmer/profile" },
  ];
